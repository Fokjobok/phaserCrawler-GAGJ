...
export class MainMenuScene extends Phaser.Scene {
    ...
    create() {
        // Crear un contenedor DOM que pida el nombre y tenga un botón "Nueva Partida"
        let container = this.add.dom(this.cameras.main.width / 2, this.cameras.main.height / 2).createFromHTML(`
            <div style="text-align: center;">
                ...
                <br><br>
                <button id="newGameButton" style="font-size: 24px; padding: 10px;">Nueva Partida</button>
            </div>
        `)
